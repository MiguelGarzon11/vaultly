  ...
  return (
    <header>
      <div className="flex flex-col gap-5 w-full">
        <section className="fixed flex flex-row justify-between w-full h-auto px-5 py-4 sm:px-10 items-center bg-back/80 backdrop-blur-sm z-50">
          <a href="/login" className="hidden sm:flex px-5 py-2 sm:px-3 w-auto rounded-2xl bg-primary text-white hover:bg-back hover:ring-1 hover:text-text hover:ring-text/50 font-medium text-sm text-nowrap">Iniciar Sesión</a>
          <div className="h-full w-full flex flex-row items-center justify-center gap-2">
            ...
            />
            <h1 className="text-3xl sm:text-4xl font-extrabold text-text text-center">Vaultly</h1>
          ...
          <a href="/register" className="hidden sm:flex px-5 py-2 w-auto rounded-2xl bg-back text-text ring-1 ring-text/50 hover:bg-secondary hover:text-white hover:ring-0 font-medium text-sm active:bg-secondary active:text-white">Registrarse</a>
          {isOpen && (
